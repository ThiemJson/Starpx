...
public class PokemonGraphQLCallQuery: GraphQLQuery {
  ...
  public struct Data: GetImage.SelectionSet {
    public let __data: DataDict
    public init(_dataDict: DataDict) { __data = _dataDict }

    public static var __parentType: ApolloAPI.ParentType { GetImage.Objects.Query_root }
    ...
    public struct Pokemon_v2_pokemon: GetImage.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: ApolloAPI.ParentType { GetImage.Objects.Pokemon_v2_pokemon }
      public static var __selections: [ApolloAPI.Selection] { [
      ...
      public struct Pokemon_v2_pokemontype: GetImage.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: ApolloAPI.ParentType { GetImage.Objects.Pokemon_v2_pokemontype }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
        ...
        public struct Pokemon_v2_type: GetImage.SelectionSet {
          public let __data: DataDict
          public init(_dataDict: DataDict) { __data = _dataDict }

          public static var __parentType: ApolloAPI.ParentType { GetImage.Objects.Pokemon_v2_type }
          public static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
            .field("name", String.self),
          ] }
